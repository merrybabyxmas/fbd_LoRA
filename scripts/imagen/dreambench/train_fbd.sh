#!/usr/bin/env bash
# FBD-LoRA: DreamBench — FBD-LoRA method
# Usage: bash scripts/imagen/dreambench/train_fbd.sh <GPU_IDS> <RUN_EVAL_AFTER_TRAIN>
set -euo pipefail
...
export METHOD="fbd"
export CONFIG_PATH="${REPO_ROOT}/configs/imagen/dreambench/fbd.yaml"
