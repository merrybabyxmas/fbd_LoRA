#!/usr/bin/env bash
# FBD-LoRA: DreamBench — LoRA DreamBooth baseline
# Usage: bash scripts/imagen/dreambench/train_lora.sh <GPU_IDS> <RUN_EVAL_AFTER_TRAIN>
set -euo pipefail
...
export METHOD="lora"
export CONFIG_PATH="${REPO_ROOT}/configs/imagen/dreambench/lora.yaml"
