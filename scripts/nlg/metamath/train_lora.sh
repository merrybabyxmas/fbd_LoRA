#!/usr/bin/env bash
# FBD-LoRA: MetaMath — LoRA baseline
# Usage: bash scripts/nlg/metamath/train_lora.sh <GPU_IDS> <RUN_EVAL_AFTER_TRAIN>
set -euo pipefail
...
export METHOD="lora"
export CONFIG_PATH="${REPO_ROOT}/configs/nlg/metamath/lora.yaml"
