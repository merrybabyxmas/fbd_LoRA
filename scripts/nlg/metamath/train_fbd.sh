#!/usr/bin/env bash
# FBD-LoRA: MetaMath — FBD-LoRA method
# Usage: bash scripts/nlg/metamath/train_fbd.sh <GPU_IDS> <RUN_EVAL_AFTER_TRAIN>
set -euo pipefail
...
export METHOD="fbd"
export CONFIG_PATH="${REPO_ROOT}/configs/nlg/metamath/fbd.yaml"
