#!/usr/bin/env bash
# FBD-LoRA: Code Generation — LoRA-GA (PLACEHOLDER — NOT IMPLEMENTED)
# Usage: bash scripts/nlg/code/train_lora_ga.sh <GPU_IDS> <RUN_EVAL_AFTER_TRAIN>
set -euo pipefail
...
export CONFIG_PATH="${REPO_ROOT}/configs/nlg/code/lora_ga.yaml"
