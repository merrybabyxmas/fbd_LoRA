#!/usr/bin/env bash
# FBD-LoRA: Conversation — LoRA baseline (PLACEHOLDER — NOT IMPLEMENTED)
# Usage: bash scripts/nlg/conversation/train_lora.sh <GPU_IDS> <RUN_EVAL_AFTER_TRAIN>
set -euo pipefail
...
export METHOD="lora"
export CONFIG_PATH="${REPO_ROOT}/configs/nlg/conversation/lora.yaml"
