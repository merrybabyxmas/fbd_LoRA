#!/usr/bin/env bash
# FBD-LoRA: DreamBench+ — Custom Diffusion real-data sanity run (SD1.5, 20 steps)
# Usage: bash scripts/sanity/imagen/dreambench/train_custom_diffusion_sd15_dreambench_plus.sh <GPU_IDS> <RUN_EVAL_AFTER_TRAIN>
set -euo pipefail
...
export CONFIG_PATH="${REPO_ROOT}/configs/sanity/imagen/dreambench/custom_diffusion_sd15_dreambench_plus.yaml"
