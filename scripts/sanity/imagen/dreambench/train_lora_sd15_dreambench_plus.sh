#!/usr/bin/env bash
# FBD-LoRA: DreamBench+ — LoRA baseline real-data sanity run (SD1.5, 20 steps)
# Usage: bash scripts/sanity/imagen/dreambench/train_lora_sd15_dreambench_plus.sh <GPU_IDS> <RUN_EVAL_AFTER_TRAIN>
set -euo pipefail
...
export METHOD="lora"
export CONFIG_PATH="${REPO_ROOT}/configs/sanity/imagen/dreambench/lora_sd15_dreambench_plus.yaml"
