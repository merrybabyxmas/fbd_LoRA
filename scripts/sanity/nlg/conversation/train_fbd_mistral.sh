#!/usr/bin/env bash
# FBD-LoRA: Conversation — FBD-LoRA real-data sanity run (Mistral-7B-v0.1, 20 steps)
# Usage: bash scripts/sanity/nlg/conversation/train_fbd_mistral.sh <GPU_IDS> <RUN_EVAL_AFTER_TRAIN>
set -euo pipefail
...
export METHOD="fbd"
export CONFIG_PATH="${REPO_ROOT}/configs/sanity/nlg/conversation/fbd_mistral.yaml"
